...
def lambda_handler(event, context):
    ...
    if object_type.startswith("image/"):
        ...
        recipient = "2022ht66533@wilp.bits-pilani.ac.in"
        sender = "2022ht66533@wilp.bits-pilani.ac.in"
        # Call email fuction
        ...
        recipient = "<Your email address whcih you setup as part of SES>"
        sender = "<Your email address whcih you setup as part of SES>"
        # Call email fuction
        response = send_email(subject, body, recipient, sender)
        print(response)
